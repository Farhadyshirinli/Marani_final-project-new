...
{
    public partial class ProductCatalogForeignKeys : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductCatalogItem", x => new { x.ProductId, x.ProductSizeId, x.ProductTypeId, x.ProductMaterialId, x.ProductColorId });
                    table.ForeignKey(
